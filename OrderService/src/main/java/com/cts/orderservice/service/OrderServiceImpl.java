...
import com.cts.orderservice.config.InventoryFeignClient;
...
public class OrderServiceImpl implements IOrderService{
    ...
    public ResOrderDTO addOrder(OrderDTO orderDTO) {
        ...
        for (Map.Entry<Long, Integer> entry : bookIds.entrySet()) {
            ...
            Map<String, Integer> quantitybody = new HashMap<>();
            quantitybody.put("quantity",quantity);
            inventoryFeignClient.decrementStock(bookId,quantitybody);
            book.setStockQuantity(book.getStockQuantity()-quantity);
            //System.out.println(book);
            logger.debug("Updating the book stock");
            BookDto bookdto = bookFeignClient.updatebook(bookId, book);
            System.out.println(bookdto.getStockQuantity());
